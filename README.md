...
### Спецификация перед разработкой
...
Разработка начинается только после проверки, что эти документы не противоречат друг другу и границы первой версии достаточно понятны.

## Текущий этап

Репозиторий сейчас находится на этапе **планирования и проектирования архитектуры**. Основная спецификация перед разработкой уже формируется в `docs/`, но production-код ещё не создаётся.
